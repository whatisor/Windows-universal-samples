...
namespace _360VideoPlayback.Common
{
    ...
    internal class DeviceResources : Disposer
    {
        ...
        public Device3 D3DDevice => d3dDevice;
        public DeviceContext3 D3DDeviceContext => d3dContext;
        public SharpDX.DXGI.Adapter3 DxgiAdapter => dxgiAdapter;
        public IDirect3DDevice D3DInteropDevice => d3dInteropDevice;
        public SharpDX.Direct2D1.Factory2 D2DFactory => d2dFactory;
        public SharpDX.DirectWrite.Factory1 DWriteFactory => dwriteFactory;
        public SharpDX.WIC.ImagingFactory2 WicImagingFactory => wicFactory;
        public SharpDX.Direct3D.FeatureLevel D3DDeviceFeatureLevel => d3dFeatureLevel;
        public bool D3DDeviceSupportsVprt => d3dDeviceSupportsVprt;
